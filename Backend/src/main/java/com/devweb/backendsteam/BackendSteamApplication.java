...
public class BackendSteamApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		hollowKnight.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		marvelRivals.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		terraria.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		skyrim.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		stardewValley.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		celeste.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		theWitcher3.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		portal2.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		deadByDaylight.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		repo.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
		...
		balatro.setLanguages(new java.util.HashSet<>(java.util.Arrays.asList(
				ingles, portugues, espanhol, alemao, frances, italiano, japones, coreano, chines
		)));
